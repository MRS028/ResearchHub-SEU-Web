    ...
    <footer className="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-start">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-sm max-w-xs">
              A centralized platform for managing, summarizing, and exploring
              research papers at Southeast University.
            </p>
          ...
          <div className="flex flex-col">
            <h3 className="text-gray-800 dark:text-gray-200 font-semibold mb-4">
              Quick Links
            </h3>
            <Link
              to="/"
              className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 py-1 transition-colors"
            >
              Home
            </Link>
            <Link
          ...
          <div className="flex flex-col">
            ...
            <p className="text-gray-600 dark:text-gray-300 py-1">
              Email: support@researchhub.seu.edu.bd
            </p>
            <p className="text-gray-600 dark:text-gray-300 py-1">
              Phone: +880 1234 567890
            </p>
            <p className="text-gray-600 dark:text-gray-300 py-1">
              Address: Southeast University, Dhaka, Bangladesh
            </p>
          </div>
        </div>
        ...
        <div className="mt-8 border-t border-gray-200 dark:border-gray-700 pt-6 text-center text-gray-500 dark:text-gray-400 text-sm">
          &copy; {new Date().getFullYear()} ResearchHub@SEU. All rights
          reserved.
        </div>
      </div>
    </footer>
